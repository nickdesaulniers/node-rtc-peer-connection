...
IceAgent.prototype.gatherStunCandidate = function (socket) {
  ...
  vsStun.resolve(socket, stunServer, function (error, value) {
    if (error) {
      ...
      throw error;
    } else if (!(('host' in value.public) && ('port' in value.public))) {
